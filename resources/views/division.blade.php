    ...
    {{ csrf_field() }}
        <table align="center" width="80%">
            ...
            <tr>
                ...
                <td> 
                    <input type="text" class="form-control" name="name" id="name" placeholder="Designation Name Here">
                </td>
            </tr>
            <tr>
                <td colspan="2">
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body" id="employee_detail">  
                        ...
                        <td> 
                            ...
                            <input type="text" class="form-control" name="ename" id="ename" placeholder="Designation Name Here">
                        </td>
                    </tr>               
                    </table>
        ...
        closeOnCancel: false
            ...
            if (isConfirm) {
                ...
                success: function(response){
                    ...
                    swal({title: "Success", text: "Designation has been deleted!", type: "success"},
                            function(){ 
                                location.reload();
                            }
                        );
