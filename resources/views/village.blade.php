...
<div class="content">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Insert Village</div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    @endif
    <form action="{{ route('store_village')}}" method="post">
    {{ csrf_field() }}
            ...
            <tr>
              ...
              <tr>			 
               <td width="50%">
                ...
                <td width="50%"> 
                    <input type="text" class="form-control" name="village_name" id="village_name" placeholder="Village Name Here">
                </td>
            </tr>
            <tr>
...
<div id="dataModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <form action="{{ route('edit_village')}}" method="post">
                    {{ csrf_field() }}
                <div class="modal-body" id="district_detail">  
                        ...
                        <table align="center" width="100%">
                            ...
                            <tr>
                             ...
                             <tr>							
                                <td> 
                                   <select id="taluka_name" name="taluka_name" class="form-control">
                                    <option value="">Select</option>
                                    </select>                
                                </td>
                            </tr>
                            ...
                            <tr>							
                                <td>
                                <input type="text" class="form-control" name="evillage_name" id="evillage_name" placeholder="District Name Here">
                                </td>
                            </tr>
     ...
     <thead>
      <tr>
       <td align="center"><b>ID</b></td>
                <td align="center"><b>Village</td>
                <td align="center"><b>Taluka</td>
                <td align="center"><b>District</td>
                <td align="center"><b>State</td>
 ...
 console.log(response['data']);
           ...
           if(len > 0){
             for(var i=0; i<len; i++){
               ...
               var village_name=response['data'][i].village_name;
               var taluka_id = response['data'][i].taluka_name;
               ...
               var tr_str = "<tr>" +
                   ...
                   "<td align='center'>" + village_name + "</td>"+
                   "<td align='center'>" + taluka_id + "</td>" +
              ...
              var tr_str = "<tr>" +
                  ...
                  "<td align='center'>" + response['data'].village_name + "</td>"+
...
$(document).on("click", ".update" , function() {
  ...
  $.ajax({
    url: "{{ route('getdatabyid_village') }}",
    type: 'get',
    data: {_token: CSRF_TOKEN,edit_id: edit_id},
    success: function(response){

        $('#edit_id').val(response.data.hash_id);
        $('#evillage_name').val(response.data.village_name);  
...
jQuery(document).ready(function ()
    {
            ...
            jQuery('select[name="dist_name"]').on('change',function(){
               var stateID = jQuery(this).val();
               if(stateID)
               {
                  jQuery.ajax({
                     ...
                     {
                        console.log(data);
                        jQuery('select[name="taluka_name"]').empty();
                        jQuery.each(data, function(key,value){
                           $('select[name="taluka_name"]').append('<option value="'+ key +'">'+ value +'</option>');
                        });
                     }
                  });
               }
