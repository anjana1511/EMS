    ...
    {{ csrf_field() }}
        <table align="center" width="80%">
            ...
            <tr>
                ...
                <td> 
                    <input type="text" class="form-control" name="name" id="name" placeholder="State Name Here">
                </td>
            </tr>
            <tr>
                <td colspan="2">
...
<div id="dataModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <form action="{{ route('edit_state')}}" method="post">
                    {{ csrf_field() }}
                <div class="modal-body" id="employee_detail">  
                        ...
                        <td> 
                            ...
                            <input type="text" class="form-control" name="ename" id="ename" placeholder="State Name Here">
                        </td>
                    </tr>               
                    </table>
